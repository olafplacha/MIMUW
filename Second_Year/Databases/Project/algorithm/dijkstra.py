...
#------------HELPER FUNCTIONS FOR DISPLAYING RESULT------------
...
def main():
    ...
    db_user = 'op429584'
    db_pass = '*****'
    cursor = cx_Oracle.connect(db_user, db_pass, "//labora.mimuw.edu.pl/LABS").cursor()
    ...
    try:
        ...
        print("Please specify date of valid format!")
        sys.exit()
    ...
    while len(pq) > 0:
        ...
        if currentDate is None:
            ...
            #for start date, we dont't care if the flight is in the morning or in the evening
    ...
    #display flights is connection was found
    if flag:
        display_result(flights, sum_price)
    else:
        print('No connection')
